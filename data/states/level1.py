...
class Level1(tools._State):
    ...
    def startup(self, current_time, persist):
        """Se llama cuando se crea el objeto Estado."""
    ...
    def setup_background(self):
        """Establece la imagen de fondo, la rectifica y la escala a la posición correcta.
         dimensiones"""
    ...
    def setup_ground(self):
        """Crea rectángulos invisibles y colisionables sobre el suelo para
    ...
    def setup_bricks(self):
        """Crea todos los ladrillos rompibles para el nivel. moneda y
         Se crean grupos de potenciadores para que puedan pasarse a ladrillos."""
    ...
    def setup_spritegroups(self):
        """Grupos de Sprite creados para mayor comodidad."""
    ...
    def update_during_transition_state(self, keys):
        """Actualiza a mario en un estado de transición (como volverse grande, pequeño,
          o muere). Comprueba si sale del estado de transición o muere.
          cambiar el estado del nivel nuevamente"""
    ...
    def check_if_mario_in_transition_state(self):
        """Si Mario está en un estado de transición, el nivel estará CONGELADO.
         estado"""
    ...
    def check_points_check(self):
        """Detectar si se produce una colisión en el punto de control, eliminar el punto de control,
    ...
    def adjust_sprite_positions(self):
        """Ajusta los sprites por sus velocidades x y y y colisiones."""
    ...
    def check_mario_x_collisions(self):
        """Comprueba si hay colisiones después de que Mario se mueva en el eje x."""
    ...
    def convert_mushrooms_to_fireflowers(self):
        """Cuando Mario crece, convierte todos los potenciadores de flores de 
        fuego en potenciadores de hongos."""
    ...
    def convert_fireflowers_to_mushrooms(self):
        """Cuando Mario se vuelve pequeño, convierte todos los potenciadores de hongos en potenciadores de 
        flores de fuego. """
        for brick in self.brick_group:
    ...
    def adjust_mario_for_x_collisions(self, collider):
        """Coloca a Mario al lado del colisionador después de moverse en el eje x."""
    ...
    def adjust_mario_for_x_shell_collisions(self, shell):
        """Se ocupa de Mario si golpea un proyectil que se mueve en el eje x."""
    ...
    def prevent_collision_conflict(self, obstacle1, obstacle2):
        """Permite colisiones sólo para el elemento más cercano a marios centerx"""
    ...
    def adjust_mario_for_y_coin_box_collisions(self, coin_box):
        """Mario choca con cajas de monedas en el eje y"""
    ...
    def adjust_mario_for_y_brick_collisions(self, brick):
        """Mario choca con ladrillos en el eje y"""
    ...
    def test_if_mario_is_falling(self):
        """Cambia a Mario a un estado CAÍDA si hay más de un píxel por encima de una tubería,
    ...
    def adjust_mario_for_y_enemy_collisions(self, enemy):
        """Mario choca con todos los enemigos en el eje y"""
    ...
    def adjust_mario_for_y_shell_collisions(self, shell):
        """Mario choca con Koopas en sus caparazones en el eje y"""
        if self.mario.y_vel > 0:
            self.game_info[c.SCORE] += 400
            self.moving_score_list.append(
                score.Score(self.mario.rect.centerx - self.viewport.x,
    ...
    def check_enemy_x_collisions(self, enemy):
        """Colisiones enemigas a lo largo del eje x. Elimina al enemigo del grupo enemigo.
         para compararlo con todos los demás enemigos, luego lo vuelve a agregar."""
        enemy.kill()
    ...
    def adjust_shell_position(self):
        """Mueve cualquier koopa en un caparazón a lo largo de los ejes x, y y verifica si
         colisiones"""
    ...
    def check_shell_x_collisions(self, shell):
        """Colisiones de proyectiles a lo largo del eje x"""
    ...
    def check_shell_y_collisions(self, shell):
        """Colisiones de proyectiles a lo largo del eje y"""
        collider = pg.sprite.spritecollideany(shell, self.ground_step_pipe_group)
    ...
    def adjust_mushroom_for_collision_y(self, item, collider):
        """Cambia el estado del hongo a DESLIZAMIENTO después de golpear el suelo tras una caída."""
    ...
    def adjust_star_position(self, star):
        """Mueve la estrella invencible a lo largo de los ejes x, y y comprueba si hay colisiones."""
    ...
    def check_if_falling(self, sprite, sprite_group):
        """Comprueba si el sprite debe entrar en estado de caída"""
        sprite.rect.y += 1
    ...
    def delete_if_off_screen(self, enemy):
        """Elimina enemigos de los grupos de sprites si quedan 500 píxeles fuera de la pantalla.
    ...
    def check_to_add_flag_score(self):
        """Agrega puntuación de bandera si está en la parte superior"""
    ...
    def check_if_time_out(self):
        """Compruebe si el tiempo ha llegado a 0"""
