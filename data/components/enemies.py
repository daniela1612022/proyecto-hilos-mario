...
class Enemy(pg.sprite.Sprite):
    ...
    def update(self, game_info, *args):
        ...
        # Usa un hilo para actualizar al enemigo
        hilo_actualizar = threading.Thread(target=self.actualizar_enemigo, args=(game_info,))
        hilo_actualizar.start()

        # Usa otro hilo para imprimir el estado del enemigo
        hilo_imprimir = threading.Thread(target=self.imprimir_estado_enemigo)
        hilo_imprimir.start()
    ...
    def actualizar_enemigo(self, game_info):
        """Actualiza el comportamiento del enemigo"""
    ...
    def imprimir_estado_enemigo(self):
        """Imprime el estado del enemigo"""
        with self.state_lock:
            print(f"Estado del enemigo: {self.state}")
...
class Goomba(Enemy):
    ...
    def setup_frames(self):
        """Coloque los marcos de imágenes en una lista para animarlos."""
