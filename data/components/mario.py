...
class Mario(pg.sprite.Sprite):
    ...
    def setup_counters(self):
        """Estos realizan un seguimiento de varios totales de valores importantes."""
        self.frame_index = 0
    ...
    def load_images_from_sheet(self):
        """Extrae imágenes de Mario de su hoja de sprites y las asigna.
         a listas apropiadas"""
        self.right_frames = []
        self.left_frames = []
        ...
        # Imágenes para el pequeño Mario verde (para la animación invencible) #

        self.right_small_green_frames.append(
            self.get_image(178, 224, 12, 16))  # Derecha parado [0]
        self.right_small_green_frames.append(
            self.get_image(80, 224, 15, 16))  # Derecha caminando 1 [1]
        self.right_small_green_frames.append(
            self.get_image(96, 224, 16, 16))  # Derecha caminando 2 [2]
        self.right_small_green_frames.append(
            self.get_image(112, 224, 15, 16))  # Derecha caminando 3 [3]
        self.right_small_green_frames.append(
            self.get_image(144, 224, 16, 16))  # Derecha salto [4]
        self.right_small_green_frames.append(
            self.get_image(130, 224, 14, 16))  # Derecha deslizamiento [5]

        # Imágenes para el Mario rojo (para la animación invencible) #

        self.right_small_red_frames.append(
            self.get_image(178, 272, 12, 16))  # Derecha parado [0]
        self.right_small_red_frames.append(
            self.get_image(80, 272, 15, 16))  # Derecha caminando 1 [1]
        self.right_small_red_frames.append(
            self.get_image(96, 272, 16, 16))  # Derecha caminando 2 [2]
        self.right_small_red_frames.append(
            self.get_image(112, 272, 15, 16))  # Derecha caminando 3 [3]
        self.right_small_red_frames.append(
            self.get_image(144, 272, 16, 16))  # Derecha salto [4]
        self.right_small_red_frames.append(
            self.get_image(130, 272, 14, 16))  # Derecha deslizamiento [5]

        # Imágenes para el Mario negro (para la animación invencible) #

        self.right_small_black_frames.append(
            self.get_image(178, 176, 12, 16))  # Derecha parado [0]
        self.right_small_black_frames.append(
            self.get_image(80, 176, 15, 16))  # Derecha caminando 1 [1]
        self.right_small_black_frames.append(
            self.get_image(96, 176, 16, 16))  # Derecha caminando 2 [2]
        self.right_small_black_frames.append(
            self.get_image(112, 176, 15, 16))  # Derecha caminando 3 [3]
        self.right_small_black_frames.append(
            self.get_image(144, 176, 16, 16))  # Derecha salto [4]
        self.right_small_black_frames.append(
            self.get_image(130, 176, 14, 16))  # Derecha deslizamiento [5]

        # Imágenes para el Mario grande normal #

        self.right_big_normal_frames.append(
            self.get_image(176, 0, 16, 32))  # Derecha parado [0]
        self.right_big_normal_frames.append(
            self.get_image(81, 0, 16, 32))  # Derecha caminando 1 [1]
        self.right_big_normal_frames.append(
            self.get_image(97, 0, 15, 32))  # Derecha caminando 2 [2]
        self.right_big_normal_frames.append(
            self.get_image(113, 0, 15, 32))  # Derecha caminando 3 [3]
        self.right_big_normal_frames.append(
            self.get_image(144, 0, 16, 32))  # Derecha salto [4]
        self.right_big_normal_frames.append(
            self.get_image(128, 0, 16, 32))  # Derecha deslizamiento [5]
        self.right_big_normal_frames.append(
            self.get_image(336, 0, 16, 32))  # Derecha lanzando [6]
        self.right_big_normal_frames.append(
            self.get_image(160, 10, 16, 22))  # Derecha agachado [7]
        self.right_big_normal_frames.append(
            self.get_image(272, 2, 16, 29))  # Transición de grande a pequeño [8]
        self.right_big_normal_frames.append(
            self.get_image(193, 2, 16, 30))  # Marco 1 del deslizamiento del mástil [9]
        self.right_big_normal_frames.append(
            self.get_image(209, 2, 16, 29))  # Marco 2 del deslizamiento del mástil [10]

        # Imágenes para el Mario grande verde #

        self.right_big_green_frames.append(
            self.get_image(176, 192, 16, 32))  # Derecha parado [0]
        self.right_big_green_frames.append(
            self.get_image(81, 192, 16, 32))  # Derecha caminando 1 [1]
        self.right_big_green_frames.append(
            self.get_image(97, 192, 15, 32))  # Derecha caminando 2 [2]
        self.right_big_green_frames.append(
            self.get_image(113, 192, 15, 32))  # Derecha caminando 3 [3]
        self.right_big_green_frames.append(
            self.get_image(144, 192, 16, 32))  # Derecha salto [4]
        self.right_big_green_frames.append(
            self.get_image(128, 192, 16, 32))  # Derecha deslizamiento [5]
        self.right_big_green_frames.append(
            self.get_image(336, 192, 16, 32))  # Derecha lanzando [6]
        self.right_big_green_frames.append(
            self.get_image(160, 202, 16, 22))  # Derecha agachado [7]

        # Imágenes para el Mario grande rojo #

        self.right_big_red_frames.append(
            self.get_image(176, 240, 16, 32))  # Derecha parado [0]
        self.right_big_red_frames.append(
            self.get_image(81, 240, 16, 32))  # Derecha caminando 1 [1]
        self.right_big_red_frames.append(
            self.get_image(97, 240, 15, 32))  # Derecha caminando 2 [2]
        self.right_big_red_frames.append(
            self.get_image(113, 240, 15, 32))  # Derecha caminando 3 [3]
        self.right_big_red_frames.append(
            self.get_image(144, 240, 16, 32))  # Derecha salto [4]
        self.right_big_red_frames.append(
            self.get_image(128, 240, 16, 32))  # Derecha deslizamiento [5]
        self.right_big_red_frames.append(
            self.get_image(336, 240, 16, 32))  # Derecha lanzando [6]
        self.right_big_red_frames.append(
            self.get_image(160, 250, 16, 22))  # Derecha agachado [7]

        # Imágenes para el Mario grande negro #

        self.right_big_black_frames.append(
            self.get_image(176, 144, 16, 32))  # Derecha parado [0]
        self.right_big_black_frames.append(
            self.get_image(81, 144, 16, 32))  # Derecha caminando 1 [1]
        self.right_big_black_frames.append(
            self.get_image(97, 144, 15, 32))  # Derecha caminando 2 [2]
        self.right_big_black_frames.append(
            self.get_image(113, 144, 15, 32))  # Derecha caminando 3 [3]
        self.right_big_black_frames.append(
            self.get_image(144, 144, 16, 32))  # Derecha salto [4]
        self.right_big_black_frames.append(
            self.get_image(128, 144, 16, 32))  # Derecha deslizamiento [5]
        self.right_big_black_frames.append(
            self.get_image(336, 144, 16, 32))  # Derecha lanzando [6]
        self.right_big_black_frames.append(
            self.get_image(160, 154, 16, 22))  # Derecha agachado [7]

        # Imágenes para el Mario de fuego #

        self.right_fire_frames.append(
            self.get_image(176, 48, 16, 32))  # Derecha parado [0]
        self.right_fire_frames.append(
            self.get_image(81, 48, 16, 32))  # Derecha caminando 1 [1]
        self.right_fire_frames.append(
            self.get_image(97, 48, 15, 32))  # Derecha caminando 2 [2]
        self.right_fire_frames.append(
            self.get_image(113, 48, 15, 32))  # Derecha caminando 3 [3]
        self.right_fire_frames.append(
            self.get_image(144, 48, 16, 32))  # Derecha salto [4]
        self.right_fire_frames.append(
            self.get_image(128, 48, 16, 32))  # Derecha deslizamiento [5]
        self.right_fire_frames.append(
            self.get_image(336, 48, 16, 32))  # Derecha lanzando [6]
        self.right_fire_frames.append(
            self.get_image(160, 58, 16, 22))  # Derecha agachado [7]
        self.right_fire_frames.append(
            self.get_image(0, 0, 0, 0))  # Marcador de posición [8]
        self.right_fire_frames.append(
            self.get_image(193, 50, 16, 29))  # Marco 1 del deslizamiento del mástil [9]
        self.right_fire_frames.append(
            self.get_image(209, 50, 16, 29))  # Marco 2 del deslizamiento del mástil [10]

        # Los frames de la imagen izquierda tienen el mismo número que los de la derecha
        # pero simplemente están invertidos.
    ...
    def update(self, keys, game_info, fire_group):
        """Actualiza los estados y animaciones de Mario una vez por cuadro."""
        self.current_time = game_info[c.CURRENT_TIME]
        self.handle_state(keys, fire_group)
        self.check_for_special_state()
        self.animate_with_threads()
    ...
    def check_to_allow_jump(self, keys):
        """Marca para permitir que Mario salte."""
    ...
    def count_number_of_fireballs(self, powerup_group):
        """Cuenta el número de bolas de fuego que existen en el nivel."""
        fireball_list = []
    ...
    def walking(self, keys, fire_group):
        """Esta función se llama cuando Mario está caminando.
         Cambia el marco, comprueba si se mantiene pulsado el botón de ejecución,
         comprueba si hay un salto y luego ajusta el estado si es necesario"""
    ...
    def jumping(self, keys, fire_group):
        """Se llama cuando Mario está en estado SALTO."""
    ...
    def falling(self, keys, fire_group):
        """Llamada cuando Mario está en estado de CAÍDA"""
        self.check_to_allow_fireball(keys)
    ...
    def jumping_to_death(self):
        """Se llama cuando Mario está en estado DEATH_JUMP."""
    ...
    def start_death_jump(self, game_info):
        """Se utiliza para poner a Mario en estado DEATH_JUMP."""
        self.dead = True
    ...
    def changing_to_big(self):
        """Cambia el atributo de imagen de Mario según el tiempo mientras
         transición a lo grande"""
        self.in_transition_state = True
    ...
    def timer_between_these_two_times(self,start_time, end_time):
        """Comprueba si el cronómetro está en el momento adecuado para la acción. Reduce
         el código feo."""
    ...
    def set_mario_to_small_image(self):
        """Durante un cambio de pequeño a grande, establece la imagen de Mario en pequeño."""
        if self.facing_right:
    ...
    def changing_to_fire(self):
        """Se llama cuando Mario está en un estado BIG_TO_FIRE (es decir, cuando
    ...
    def changing_to_small(self):
        """El estado y la animación de Mario cuando se reduce de grande a pequeño.
    ...
    def sitting_at_bottom_of_pole(self):
        """Indica cuando mario está en la parte inferior del asta de la bandera."""
        if self.flag_pole_timer == 0:
            self.flag_pole_timer = self.current_time
    ...
    def walking_to_castle(self):
        """Indica cuándo Mario camina hacia el castillo para terminar el nivel."""
        self.max_x_vel = 5
        self.x_accel = c.WALK_ACCEL
    ...
    def falling_at_end_of_level(self, *args):
        """Estado cuando Mario se cae de la base del asta de la bandera"""
        self.y_vel += c.GRAVITY

    def check_for_special_state(self):
        """Determina si Mario es invencible, Mario despedido o herido recientemente."""
    ...
    def check_if_hurt_invincible(self):
        """Comprueba si Mario sigue siendo temporalmente invencible después de resultar herido"""
    ...
    def hurt_invincible_check(self):
        """Hace que Mario sea invencible en un intervalo fijol"""
    ...
    def animate_with_threads(self):
        """Animar con hilos y mostrar el estado en la consola."""
        threads = []

        for _ in range(5):  # Ajusta el número de hilos según sea necesario
            thread = threading.Thread(target=self.animation)
        ...
        print(f"Estado actual Mario: {self.state}")
